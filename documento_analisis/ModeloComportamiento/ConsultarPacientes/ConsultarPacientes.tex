...
\begin{UseCase}{CU21}{Consultar Pacientes}{El gerente visualizará la información de todos los pacientes registrados en el sistema cuando lo necesite. El sistema mostrará la información de los pacientes.}
    ...
    \UCitem{Entradas}{
        \begin{itemize}
            ...
            \end{itemize}
            \item Tipo de usuario: cadena de caracteres.Para el CU21 el tipo de usuario debe tener ``ROLE$\_$GERENTE'' como valor.
        \end{itemize} 
    }
    \UCitem{Origen}{
        \begin{itemize}
            \item Email del gerente: Variable de sesión de la aplicación.
            \item Tipo de usuario: Variable de sesión en el servidor.
        \end{itemize}
    }
    \UCitem{Salidas}{
        \begin{itemize}
    ...
    \UCitem{Errores}{
    	\begin{itemize}
	    	\item ERR1 - La entrada ``tipo de usuario'' es diferente de ``ROLE GERENTE'':
	    	\begin{itemize}
...
\begin{UCtrayectoria}{}
		...
		\UCpaso solicita los datos de los pacientes registrados al repositorio de datos. [ERR2].
