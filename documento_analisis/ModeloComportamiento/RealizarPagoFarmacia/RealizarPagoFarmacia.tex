%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	...
	\UCitem{Versión}{0.1}
    \UCitem{Actor}{Cajero}
    \UCitem{Propósito}{Que el medicamento que se sale del inventario sea actualizado tanto en la cantidad del inventario como el ingreso que representa la salida de éste para la clínica.}
    \UCitem{Entradas}{
        \begin{itemize}        	
