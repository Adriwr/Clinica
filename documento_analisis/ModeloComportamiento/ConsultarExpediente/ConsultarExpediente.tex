...
\begin{UseCase}{Cu10}{Consultar expediente médico}{El actor desea consultar el expediente médico.}
    ...
    \UCitem{Propósito}{Conocer los antecedentes médicos del actor paciente.}
    \UCitem{Entradas}{
        \begin{itemize}
            \item ID del paciente: Identificador único que identifica al paciente en el repositorio de datos  
  ...
  \item Lista de antecedentes familiares
    ...
    \UCitem{Observaciones}{
    	...
    	\item Existen elementos que son mínimo uno, para esos elementos se hará una lista para mostrarlos todos.
    	\end{itemize}
