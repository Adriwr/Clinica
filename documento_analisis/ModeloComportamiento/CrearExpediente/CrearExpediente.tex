...
\begin{UseCase}{Cu6}{Crear expediente médico}{El actor desea consultar el expediente médico.}
	\UCitem{Versión}{0.1}
...
\begin{UCtrayectoria}{Médico}
		\UCpaso[\UCactor] solicita las próximas citas dando click en \IUbutton{Proximas citas}.
		\UCpaso Proporciona un listado de todas las citas próximas que tiene agendadas el médico. 
		...
		\UCpaso [\UCactor] Confirma los datos haciendo click en el botón \IUbutton{Finalizar registro de expediente}
