...
\begin{UseCase}{Cu6}{Consultar consultas dadas}{El actor desea consultar las consultas dadas por cada médico.}
    \UCitem{Versión}{0.2}
    ...
    \UCitem{Salidas}{
        \begin{itemize}
            \item Lista médicos
        \begin{itemize}
            \item *Nombre: Constituido por nombre(s) y apellido(s) del medico
