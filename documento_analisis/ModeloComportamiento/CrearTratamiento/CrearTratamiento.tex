...
\begin{UseCase}{CU11}{Crear tratamiento}{El médico podrá proporcionar un tratamiento al paciente con base en los sintomas y su experiencia. El sistema guardará la información del tratamiento.}
	\UCitem{Version}{0.2}
  \UCitem{Actor}{Médico}
  \UCitem{Proposito}{
    Que el Médico pueda brindar un tratamiento que ayude al paciente a mejorar su estado de salúd y este sea registrado en el sistema junto a la consulta, con el fin de ser incorporado al expediente medico.
  }
  \UCitem{Entradas}{
    \begin{itemize}
